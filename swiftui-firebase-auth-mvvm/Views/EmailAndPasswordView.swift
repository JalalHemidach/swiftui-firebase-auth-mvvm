    ...
    fileprivate func emailView(
        ...
        return
            VStack(alignment: .leading, spacing: 0) {
                ...
                .onChange(of: emailAndPasswordViewModel.email) {
                    emailAndPasswordViewModel.clearAuthenticationErrorMessage()
                }
    ...
    fileprivate func emailErrorView() -> some View {
        return
            Group {
                ...
                {
                    Text("⚠️ Enter a valid email address")
                        .foregroundStyle(.red)
                        .font(.caption)
                }
            }
            ...
            Group {
                    ...
                    )
                {
                    ...
                    emailAndPasswordViewModel
                        .shouldDisplayAuthenticationErrorMessage
                {
                    Text(emailAndPasswordViewModel.authenticationErrorMessage)
                        .foregroundStyle(.red)
                        .font(.caption)
                }
            }
        ...
        return
            Group {
                    ...
                    )
                {
                    ...
                    Text(
                        self.emailAndPasswordViewModel.authenticationErrorMessage
                    )
                    .foregroundStyle(.red)
                    .font(.caption)
                }
